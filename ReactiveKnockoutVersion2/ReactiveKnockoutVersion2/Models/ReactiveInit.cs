...
namespace ReactiveKnockoutVersion2.Models
{
    public class ReactiveInit : DropCreateDatabaseIfModelChanges<MVC_ReactiveContext>
    {
        ...
        {
            context.Employees.Add(new Employee() { FirstName = "Scooby", LastName = "Doo" });
            context.Employees.Add(new Employee() { FirstName = "Scrappy", LastName = "Doo" });
            context.Employees.Add(new Employee() { FirstName = "Shaggy", LastName = "Rogers" });
            context.Employees.Add(new Employee() { FirstName = "Fred", LastName = "Jones" });
            context.Employees.Add(new Employee() { FirstName = "Daphne", LastName = "Blake" });
            context.Employees.Add(new Employee() { FirstName = "Velma", LastName = "Dinkley" });
